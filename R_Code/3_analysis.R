...
geom_text(aes(y=Party, x=Percent,label=round(Percent)),alpha=1,position=position_dodge(width=0.9), hjust=-0.5)+
...
#### 2021 provincial support by historic levels of support#### 
waterloo2 %>% 
